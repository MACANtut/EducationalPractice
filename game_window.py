...
from PyQt6.QtGui import QPainter, QColor, QBrush, QIcon, QLinearGradient, QPalette
...
class HanoiTowersGame(QWidget):
    ...
    def init_audio(self):
        ...
        self.background_player.setSource(QUrl.fromLocalFile("sound/музыка.mp3"))
        ...
        self.win_player.setSource(QUrl.fromLocalFile("sound/победа.mp3"))
    ...
    def initUI(self):
        ...
        self.music_button.setFixedSize(50, 50)
        ...
        self.music_button.move(self.width() - 60, 10)
    ...
    def update_next_level_button_state(self):
        self.next_level_button.setEnabled(self.level < self.max_levels)
